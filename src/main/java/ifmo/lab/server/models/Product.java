...
public class Product implements Comparable<Product> {
    ...
    public Product (long id, String name, Coordinates coordinates, Date creationDate, float price, String partNumber, Double manufactureCost, UnitOfMeasure unitOfMeasure, Person owner){
        this.id = id;
        this.name = name;
    ...
    public Product(String name, Coordinates coordinates, float price, String partNumber, Double manufactureCost, UnitOfMeasure unitOfMeasure, Person owner) {
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = new Date();
        this.price = price;
    ...
    public boolean validate(){
        ...
        if (partNumber.length() < 28 || partNumber.length() > 48) return false;
